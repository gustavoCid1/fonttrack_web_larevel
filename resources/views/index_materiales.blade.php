        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form id="formFalla">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="password" name="reviso_por" id="reviso_por" class="form-control" placeholder="Ingresa tu contraseña para firmar" required>
                    ...
                    <div class="modal-footer gradient-primary">
                        <button type="button" id="btnVerPDF" class="btn btn-info position-relative" disabled data-bs-toggle="tooltip" data-bs-placement="top" title="⚠️ ADVERTENCIA: Al presionar este botón se guardará automáticamente el registro en la base de datos y NO se podrá eliminar posteriormente.">Ver PDF</button>
    ...
    <script>
        $(document).ready(function () {
            ...
            function openMaterialModal(mode, data = {}) {
                ...
                if (mode === 'view') {
                    ...
                    body.html(`
                        ...
                        <p><strong>Genérico:</strong> ${data.generico}</p>
            ...
            function cargarUsuariosDelLugar(idLugar) {
                ...
                if (!idLugar) {
                    console.log('No se seleccionó ningún lugar, limpiando dropdown');
